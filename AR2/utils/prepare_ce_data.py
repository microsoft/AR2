...
if __name__ == "__main__":
    ...
    # inference_results = '/mnt/data/denseIR/ckpt/run_de_model_ict_ernie/40k/dev_result_dict_list.json'
    # outfile = "./dev_ce_0.json"
    # ground_truth_path = "/mnt/data/denseIR/data/retriever/nq-dev.json"
